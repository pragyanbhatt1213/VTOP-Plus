...
import GooglePlayProtectSection from '@/components/GooglePlayProtectSection';
    ...
    <section id="download" className="py-32 sm:py-40 lg:py-56 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <p className="text-txt-secondary text-sm mb-6 max-w-xl mx-auto">
        ...
        {/* 2. Security Info Card */}
        <div className="mb-10">
          <SecurityInfoCard />
        </div>

        {/* 3. Play Protect Proof */}
        <GooglePlayProtectSection />
        ...
        >
          <motion.a
            ...
            className="inline-flex items-center gap-3 px-8 sm:px-12 py-4 rounded-2xl
                       ...
                       transition-all duration-300 glow-animate"
          ...
          {/* Subtext */}
          <p className="text-xs text-txt-secondary font-mono mt-4">
            Free • Safe • Direct from GitHub
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8 pt-8 border-t border-txt-muted/10"
        >
          {meta.map((m) => (
            <motion.div
              key={m.label}
